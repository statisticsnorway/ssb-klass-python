...
class KlassVariant():
    def __init__(self,
        ...
        for key, value in variants_by_id(self.variant_id, 
                                         self.language).items():
...
class KlassVariantCodes():
    def __init__(self, 
        ...
        if self.to_date:
            result = variant(classification_id=self.classification_id,
            ...
            result = variant_at(classification_id=self.classification_id,
                                variant_name=self.variant_name,
                                date=self.from_date,
                                select_codes=self.select_codes,
                                select_level=self.select_level,
