...
def validate_select_codes(codestring: str) -> str:
    ...
    if not check.isdigit():
        raise ValueError('Select-codes may only contain numbers and these special characters: *-,')
    return codestring
...
def validate_alnum_spaces(variant_name: str) -> str:
    ...
    if not check.isalnum():
        raise ValueError("Expecting variant name to only include numbers, characters and spaces...")
    return variant_name
