...
@mock.patch.object(klass.KlassClassification, "get_version")
def test_get_variant_with_only_search_string(mock_get_version, klassvariant_mock, klass_classification_success, klass_version_success, klass_variant_success):
    mock_get_version.return_value = klass_version_success
    klassvariant_mock.return_value = klass_variant_success
    variant = klass_classification_success.get_latest_variant_by_name("Forskerutdanning")
